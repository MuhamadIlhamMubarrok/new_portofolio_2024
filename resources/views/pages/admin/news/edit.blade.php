                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="category" name="category">
                                    <option value="work experience"
                                        {{ $news->category == 'work experience' ? 'selected' : '' }}>Work Experience
                                    </option>
                                    <option value="hobby" {{ $news->category == 'hobby' ? 'selected' : '' }}>Hobby</option>
                                    <option value="achievment" {{ $news->category == 'achievment' ? 'selected' : '' }}>
                                        Achievement</option>
                                </select>
                            </div>
